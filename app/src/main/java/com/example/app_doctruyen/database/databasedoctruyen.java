package com.example.app_doctruyen.database;
...
public class databasedoctruyen extends SQLiteOpenHelper {
    ...
    //phân quyền 1.admin và 2.người dùng
    private String SQLQuery2 = "INSERT INTO TaiKhoan VAlUES (null,'admin','admin','admin@gmail.com',2)";
    private String SQLQuery3 = "INSERT INTO TaiKhoan VAlUES (null,'phuong','123456','phuong@gmail.com',1)";
    ...
    public  void AddTaiKhoan(TaiKhoan taikhoan){
        ...
        //thực hiện insert thông qua contextValues
        ...
        //đống lại khi không đúng
        db.close();
        Log.e("ADD TK","TC");

    }

    //Lây 3 truyện mới nhất
